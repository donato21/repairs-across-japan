...
func _on_NameCheckBox_toggled(button_pressed):
	if button_pressed and $Control/VBoxContainer/HBoxContainer4/BackTireCheckBox.pressed and $Control/VBoxContainer/HBoxContainer5/FrontTireCheckBox.pressed:
		$Control/Button.show()
	else:
		$Control/Button.hide()
...
func _on_BackTireCheckBox_toggled(button_pressed):
	if button_pressed and $Control/VBoxContainer/HBoxContainer/NameCheckBox.pressed and $Control/VBoxContainer/HBoxContainer5/FrontTireCheckBox.pressed:
		$Control/Button.show()
	else:
		$Control/Button.hide()
...
func _on_FrontTireCheckBox_toggled(button_pressed):
	if button_pressed and $Control/VBoxContainer/HBoxContainer/NameCheckBox.pressed and $Control/VBoxContainer/HBoxContainer4/BackTireCheckBox.pressed:
		$Control/Button.show()
	else:
		$Control/Button.hide()
